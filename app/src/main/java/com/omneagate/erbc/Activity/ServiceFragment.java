          ...
          /*  progressBar = new CustomProgressDialog(getActivity());
            ...
            if (networkConnection.isNetworkAvailable()) {
              //  progressBar.show();
                ...
                Log.e("Service Fragment","grievance Type SERVICE Called");
                GrievanceDto grievanceDto = new GrievanceDto();
                grievanceDto.setGrievanceType(GrievanceType.SERVICE);
                ...
                Log.e("Service Fragment","request"+grievance.toString());
...
*/
    private void submitBtnClick() {
        try {
            ...
            complaints.setGrievanceType(GrievanceType.SERVICE);
            progressBar = new CustomProgressDialog(getActivity());
            progressBar.setCanceledOnTouchOutside(false);
            if (networkConnection.isNetworkAvailable()) {
                progressBar.show();
    ...
    public void onResume() {
        ...
        GlobalAppState.getInstance().trackScreenView("Service Fragment");
    }
}
