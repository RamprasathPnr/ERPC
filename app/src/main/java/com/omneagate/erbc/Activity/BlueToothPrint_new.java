...
//            context.startActivityForResult(intentBtEnabled, REQUEST_ENABLE_BT);
...
//    }
    ...
    private class ConnectRunnable extends Thread {
        public void run() {
            ...
            try {
                BluetoothConnector_new.BluetoothSocketWrapper socketwrapper = blue.connect();
                if (socketwrapper != null) {
                    exception = false;
                    mmSocket = socketwrapper.getUnderlyingSocket();
...
//                byte[] normalText = new byte[3];
//                normalText[0] = (byte) 17;
//                normalText[1] = (byte) 27;
//                mmOutputStream.write(normalText);
