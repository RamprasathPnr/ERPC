...
public class UndoBar {
    ...
    protected final com.omneagate.erbc.UndoBar.ViewCompat mViewCompat;
    ...
    protected void animateOut() {
        mViewCompat.animateOut(mAnimationDuration, new com.omneagate.erbc.UndoBar.ViewCompat.AnimatorListener() {
            @Override
    ...
    public static class Builder {
        ...
        /**
         * Constructor using the {@link Dialog} in which the undo bar will be
         * displayed
         */
        ...
        public com.omneagate.erbc.UndoBar.UndoBar create() {
            com.omneagate.erbc.UndoBar.UndoBar undoBarController = new com.omneagate.erbc.UndoBar.UndoBar(mWindow, mStyle);
